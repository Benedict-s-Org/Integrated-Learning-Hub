-- Add p_skip_daily_count support and metadata to pending_rewards

-- 1. Add metadata to pending_rewards
ALTER TABLE IF EXISTS public.pending_rewards 
ADD COLUMN IF NOT EXISTS metadata JSONB DEFAULT '{}';

-- 2. Update increment_room_coins RPC

...
BEGIN
    ...
    IF EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename = 'users') THEN
        INSERT INTO public.users (id, username, password_hash, role, display_name, created_at)
        VALUES ('00000000-0000-0000-0000-000000000000', 'system_default', 'placeholder_hash', 'user', '系統預設 (Master Default)', NOW())

-- Migration: Robust User Synchronization
-- Updates the trigger to sync public.users on both INSERT and UPDATE of auth.users

-- 1. Redefine the trigger function to be more robust
...
BEGIN
  ...
  ON CONFLICT (username) DO UPDATE SET
    -- DO NOT update ID here as it might cause FK violations if it changed

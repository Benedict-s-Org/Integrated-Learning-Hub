-- 1. Ensure batch_id exists in coin_transactions
ALTER TABLE public.coin_transactions ADD COLUMN IF NOT EXISTS batch_id UUID;

-- 2. Update increment_room_coins to the most complete and robust version

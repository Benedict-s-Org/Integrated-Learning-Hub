-- Improve analytics RPCs for class-based dashboarding

-- 1. Redefine get_class_analytics_summary to return per-class stats
-- We drop and recreate because return type changes from jsonb to SETOF jsonb

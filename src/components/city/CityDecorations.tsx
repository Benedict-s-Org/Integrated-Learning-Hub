  ...
  return (
    <g transform={`translate(${x + offsetX}, ${y + offsetY})`}>
      ...
      <ellipse 
        ...
        rx={finalWidth / 3} 
        ry={finalHeight / 8} 
        fill={CARTOON_PALETTE.shadows.soft} 
      />
...
function CuteLamp({ x, y }: { x: number; y: number }) {
  ...
  return (
    <g transform={`translate(${x}, ${y})`}>
      {/* Soft shadow */}
      <ellipse cx={0} cy={5} rx={10} ry={5} fill={CARTOON_PALETTE.shadows.soft} />
...
function CuteBench({ x, y, rotation = 0 }: { x: number; y: number; rotation?: number }) {
  ...
  return (
    <g transform={`translate(${x}, ${y}) rotate(${rotation * 90})`}>
      {/* Soft shadow */}
      <ellipse cx={0} cy={5} rx={18} ry={7} fill={CARTOON_PALETTE.shadows.soft} />
...
function CuteFountain({ x, y }: { x: number; y: number }) {
  ...
  return (
    <g transform={`translate(${x}, ${y})`}>
      {/* Soft shadow */}
      <ellipse cx={0} cy={8} rx={28} ry={14} fill={CARTOON_PALETTE.shadows.medium} />
...
function CuteBush({ x, y, variant }: { x: number; y: number; variant?: string }) {
  ...
  return (
    <g transform={`translate(${x}, ${y})`} className="animate-sway-gentle" style={{ transformOrigin: `${x}px ${y}px` }}>
      {/* Soft shadow */}
      <ellipse cx={0} cy={5} rx={14} ry={6} fill={CARTOON_PALETTE.shadows.soft} />
...
function CuteMushroom({ x, y }: { x: number; y: number }) {
  ...
  return (
    <g transform={`translate(${x}, ${y})`}>
      {/* Soft shadow */}
      <ellipse cx={0} cy={5} rx={10} ry={4} fill={CARTOON_PALETTE.shadows.soft} />
...
function CuteBirdhouse({ x, y }: { x: number; y: number }) {
  ...
  return (
    <g transform={`translate(${x}, ${y})`} className="animate-sway-gentle" style={{ transformOrigin: `${x}px ${y}px` }}>
      {/* Soft shadow */}
      <ellipse cx={0} cy={5} rx={8} ry={4} fill={CARTOON_PALETTE.shadows.soft} />
...
function CuteRock({ x, y, variant }: { x: number; y: number; variant?: string }) {
  ...
  return (
    <g transform={`translate(${x}, ${y}) scale(${scale})`}>
      {/* Soft shadow */}
      <ellipse cx={0} cy={4} rx={14} ry={5} fill={CARTOON_PALETTE.shadows.soft} />

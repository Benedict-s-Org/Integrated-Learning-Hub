...
import { Save, Loader2, Brain, Info, Target, HelpCircle, Hash, Type, CheckCircle2, AlertCircle, Eye } from "lucide-react";
...
export default function PredictionEditor({ cmsKey, taskLabel, onPreview }: Props) {
